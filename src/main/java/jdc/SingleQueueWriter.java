...
public final class SingleQueueWriter<T> implements IpcQueueWriter<T> {
    ...
    public SingleQueueWriter(@NotNull final String name,
                             @NotNull final MappedByteBuffer writeBuffer,
    ...
    public static SingleQueueWriter<Integer> intsWriter(@NotNull final String name) throws IOException {
        int bufferSize = 4;
    ...
    public static SingleQueueWriter<Answer> answersWriter(@NotNull final String name) throws IOException {
        int bufferSize = 8;
